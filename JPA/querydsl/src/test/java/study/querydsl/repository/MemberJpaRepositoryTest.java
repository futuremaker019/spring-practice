...
//        condition.setTeamName("teamB");
        /**
         * 중요!! 아무런 조건이 없을경우에는 기본값이나 limit를 지정해줘야 많은 데이터를 가져오지 않는다.
         * (조건이 없으면 Where절이 들어가지 않음)
         */
    ...
    public void searchWhereMethod() {
        ...
        assertThat(result).extracting("").containsExactly("member4");
